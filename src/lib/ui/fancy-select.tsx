      ...
      const Item = (
        <CommandItem
          ...
          onSelect={(value: string) => {
            ...
            setInputValue("");
            creatableCallback && creatableCallback(value);
    ...
    return (
      ...
      >
        ...
        <div className="relative mt-2">
          {open && (
            <CommandList className="text-popover-foreground absolute top-0 z-10 max-h-[170px] w-full rounded-md border bg-white shadow-md outline-none animate-in">
              {isLoading ? (
                <>{loadingIndicator}</>
              ) : (
                <>
